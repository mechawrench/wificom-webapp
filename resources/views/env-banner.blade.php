<div class="bg-orange-500 text-center p-3 ml-300 sm:pl-50" style="height: 160px; max-height: 160px;">
    ...
    <div class="mx-auto sm:w-full" style="resize: both; overflow: auto;">
        ...
        <p class="text-white text-base sm:text-sm md:text-sm"><i>Please note that the database resets periodically, and the wificom secrets.py file must be updated for the new MQTT server</i></p>
